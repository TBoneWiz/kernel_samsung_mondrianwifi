...
extern void max77888_muic_regdump(void);
struct max77888_dev *max77888_backup;
...
static const u8 max77888_mask_reg[] = {
	...
	[MUIC_INT3] = MAX77888_MUIC_REG_INTMASK3,
};
...
static const struct max77888_irq_data max77888_irqs[] = {
	...
	DECLARE_IRQ(MAX77888_CHG_IRQ_WCIN_I,	CHG_INT, 1 << 5),
	DECLARE_IRQ(MAX77888_CHG_IRQ_CHGIN_I,	CHG_INT, 1 << 6),

	DECLARE_IRQ(MAX77888_MUIC_IRQ_INT1_ADC,	MUIC_INT1, 1 << 0),
	DECLARE_IRQ(MAX77888_MUIC_IRQ_INT1_ADCLOW,	MUIC_INT1, 1 << 1),
	...
	DECLARE_IRQ(MAX77888_MUIC_IRQ_INT2_VIDRM,	MUIC_INT2, 1 << 5),

	DECLARE_IRQ(MAX77888_MUIC_IRQ_INT3_EOC,	MUIC_INT3, 1 << 0),
	DECLARE_IRQ(MAX77888_MUIC_IRQ_INT3_CGMBC,	MUIC_INT3, 1 << 1),
	DECLARE_IRQ(MAX77888_MUIC_IRQ_INT3_OVP,	MUIC_INT3, 1 << 2),
	DECLARE_IRQ(MAX77888_MUIC_IRQ_INT3_MBCCHGERR,	MUIC_INT3, 1 << 3),
	DECLARE_IRQ(MAX77888_MUIC_IRQ_INT3_CHGENABLED,	MUIC_INT3, 1 << 4),
	DECLARE_IRQ(MAX77888_MUIC_IRQ_INT3_BATDET,	MUIC_INT3, 1 << 5),
};
...
static void max77888_restore_muic_reg(struct work_struct *work) {
	_max77888_restore_muic_reg(max77888_backup);
}
...
#ifdef CONFIG_MUIC_RESET_PIN_ENABLE
static irqreturn_t max77888_reset_irq_thread(int irq, void *data)
{
	max77888_backup = data;
